...
| [CTC Traders API v2.0 reference](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/common-transit-convention-traders/2.1/oas/page) | Technical                        | Low level   | How to use each API endpoint                                                                                                                                                                                                                                | Software developers<br>Technical architects                                          |
